...
import { RiskWorkspace } from "@/components/ProductWorkspaces";
...
export const Route = createFileRoute("/products/risk")({
  head: () => ({
    meta: [
      { title: "VendorXa Risk — Continuous third-party monitoring" },
      {
        name: "description",
        content:
          "Continuously assess vendor risk across security, financial, ESG and compliance dimensions.",
      },
  ...
  component: () => (
    <ProductPage
      ...
      workspaceHint="Interactive preview — switch vendors and inspect findings, scores and monitoring"
      features={[
        {
          icon: <ShieldAlert className="h-5 w-5" />,
          t: "Risk scoring",
          d: "Composite scores across security, financial, legal and ESG signals.",
        },
        {
          icon: <Radar className="h-5 w-5" />,
          t: "Continuous monitoring",
          d: "Automated re-assessments and alerts when risk profiles change.",
        },
        {
          icon: <Activity className="h-5 w-5" />,
          t: "Security posture",
          d: "Track questionnaires, controls and evidence in one live view.",
        },
        {
          icon: <Leaf className="h-5 w-5" />,
          t: "ESG tracking",
          d: "Capture, verify and report ESG data against your framework of choice.",
        },
        {
          icon: <TrendingUp className="h-5 w-5" />,
          t: "Financial health",
          d: "Ongoing insight into vendor financial stability and concentration.",
        },
        {
          icon: <Fingerprint className="h-5 w-5" />,
          t: "Ownership visibility",
          d: "Beneficial ownership and sanctions screening built in.",
        },
      ]}
      benefits={[
      ...
      faq={[
        {
          ...
          a: "VendorXa combines internal signals (questionnaires, contracts, incidents) with external monitoring feeds and financial data providers.",
        },
        {
          q: "Can we bring our own risk framework?",
          a: "Yes — scoring weights, tiering and control libraries are configurable to match your existing methodology.",
        },
        {
          q: "How are alerts delivered?",
          a: "In-app, email, Slack and via webhook — with severity thresholds you control per team.",
        },
      ]}
    />
  ),
