...
import { ArrowRight, Eye, ClipboardCheck } from "lucide-react";
...
import { Check, TrendingDown, ShieldCheck, Layers3 } from "lucide-react";
    ...
    <Shell>
          ...
          <div className="grid lg:grid-cols-2 gap-14 items-center w-full">
            <div>
              ...
              <div className="mt-10 flex items-center gap-6 text-xs text-muted-foreground">
                <div className="flex items-center gap-1.5"><Check className="h-3.5 w-3.5 text-accent" /> SOC 2 ready</div>
        ...
        <div className="grid lg:grid-cols-2 gap-14 items-center">
          <div>
            ...
            <p className="mt-5 text-[15px] text-muted-foreground leading-relaxed max-w-md">
              Contracts, security reviews, ESG documents and financial assessments are scattered across email, spreadsheets and disconnected tools — leaving teams without visibility and vendors without answers.
            </p>
      ...
      <section id="platform" className="mx-auto max-w-7xl px-6 py-24">
        <SectionHeader
          ...
          title={<>One workspace for complete <span className="font-editorial text-accent">vendor visibility.</span></>}
      ...
      <section className="mx-auto max-w-7xl px-6 py-24">
        ...
        <div className="mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-5">
          {[
            { icon: TrendingDown, t: "Faster Onboarding", d: "Reduce onboarding time by up to 60% with structured workflows." },
            { icon: ShieldCheck, t: "Lower Risk", d: "Continuously monitor risk and ensure ongoing compliance." },
            { icon: Eye, t: "Complete Visibility", d: "One source of truth across security, finance, legal and procurement." },
            { icon: ClipboardCheck, t: "Stronger Compliance", d: "Stay audit-ready with centralised documents and approvals." },
            { icon: Layers3, t: "Scalable Platform", d: "Enterprise-grade security and scalability for every organisation." },
          ].map((b) => (
      ...
      <section className="mx-auto max-w-7xl px-6 py-20">
        <div className="surface-card p-10 md:p-14">
          <div className="text-xs uppercase tracking-[0.2em] text-muted-foreground text-center">Trusted by our customers</div>
...
function ProductCard({
  tone, eyebrow, title, desc, bullets, to, cta,
}: {
  ...
  const tones = {
    emerald: { chip: "bg-emerald-500 text-white", ring: "before:from-emerald-400/40", text: "text-emerald-700", check: "text-emerald-500" },
    amber: { chip: "bg-amber-500 text-white", ring: "before:from-amber-400/40", text: "text-amber-700", check: "text-amber-500" },
    indigo: { chip: "bg-indigo-500 text-white", ring: "before:from-indigo-400/40", text: "text-indigo-700", check: "text-indigo-500" },
  }[tone];
  return (
